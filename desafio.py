...
def listar_usuario(cpf, usuarios):
    lista_de_usuarios = [usuario for usuario in usuarios if usuario["cpf"] == cpf]

    return lista_de_usuarios[0] if lista_de_usuarios else None
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    print("\nErro ao criar conta, usuário não encontrado.")
